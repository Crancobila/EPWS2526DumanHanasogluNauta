...
export default function ResultScreen({ navigation, route }) {
  ...
  const instructions = result?.recycling_info?.instructions;
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.content}>
          ...
          {!showNetworkError && !showNoDetection && instructions && (
            <View style={styles.instructionsBox}>
              <Ionicons name="information-circle" size={18} color={colors.blueText} />
